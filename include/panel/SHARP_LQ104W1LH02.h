...
#define CONFIG_DISPLAY_VERTICAL_SYNC			1		// 0: normal, 1: Invert
...
#define CONFIG_DISPLAY_CLOCK_MAX 150
 ...
 */
#define CONFIG_DISP_HORIZONTAL_TOTAL   1340// 1380
#define CONFIG_DISP_VERTICAL_TOTAL   640
...
#define CONFIG_DISP_DEN_END_HPOS 1024+32
#define CONFIG_DISP_DEN_STA_VPOS 32
#define CONFIG_DISP_DEN_END_VPOS 600+32
/*
...
#define CONFIG_DISP_HSYNC_LASTLINE 1600
...
#define	LVDS_TO_LIGHT_ON_ms		100      // Delay(T3):    Settings: LVDS Signal --> Backlight On
/////////////////////////////
//On --> Off	Sequence
/////////////////////////////
