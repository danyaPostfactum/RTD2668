...
#define CONFIG_DISPLAY_CLOCK_TYPICAL 95	// hsliao 20081008

/*
 * Display total window setup
 */
#define CONFIG_DISP_HORIZONTAL_TOTAL 1428
#define CONFIG_DISP_VERTICAL_TOTAL 1172
...
#define CONFIG_DISP_DEN_END_VPOS 1024+16
/*
...
//Off --> On Sequence
/////////////////////////////
#define	PANEL_TO_LVDS_ON_ms		20		 // Delay(T1+T2): Panel Power --> LVDS Signal
...
#define	LVDS_TO_PANEL_OFF_ms		49   // Delay(T5+T6): LVDS Signal Off --> Panel Power Off
////////////////////////////
//Panel Off--> Next On
////////////////////////////
