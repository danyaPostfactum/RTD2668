 ...
 * Display Setup
 */
#define CONFIG_DISPLAY_PANEL_STYLE                            _PANEL_INTERFACE_RSDS         // _PANEL_INTERFACE_LVDS or _PANEL_INTERFACE_RSDS or _PANEL_INTERFACE_TTL
...
#if _PANEL_TYPE==_PANEL_INTERFACE_RSDS
#define CONFIG_DISPLAY_PORTAB_SWAP	0		// 0: No Swap, 1: Swap   //HPWang
#else
#define CONFIG_DISPLAY_PORTAB_SWAP	1
#endif
 ...
 */
#define CONFIG_DISP_HORIZONTAL_TOTAL 1719
#define CONFIG_DISP_VERTICAL_TOTAL 850
 ...
 */
#define CONFIG_DISP_DEN_STA_HPOS 111
#define CONFIG_DISP_DEN_END_HPOS 1477
#define CONFIG_DISP_DEN_STA_VPOS 20
...
#define CONFIG_DISP_HSYNC_LASTLINE 1719
#define CONFIG_DISP_DCLK_DELAY 2

#define _CONFIG_DISP_ACT_STA_BIOS	0x00
#define CONFIG_DEFAULT_DPLL_M_DIVIDER		0x58
...
#define	LVDS_TO_LIGHT_ON_ms		400      // Delay(T3):    Settings: LVDS Signal --> Backlight On
/////////////////////////////
//On --> Off	Sequence
/////////////////////////////
