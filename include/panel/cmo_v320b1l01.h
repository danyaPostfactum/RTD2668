...
#define CONFIG_DISPLAY_BITMAPPING_TABLE  _PANEL_DISPLAY_BITMAPPING_TABLE1	//	1  	// 0: Table1, 1:Table2			//Renee:1
#define CONFIG_DISPLAY_PORTAB_SWAP		1	// 0: No Swap, 1: Swap					//Renee:0
...
#define CONFIG_DISPLAY_CLOCK_MAX 77   //gallon suggestion for lg32 panel
#else
#define CONFIG_DISPLAY_CLOCK_MAX 88   //hpwang 20071119
#endif
...
#if 0//defined(CONFIG_CUSTOMER_REALTEK)		//gallon 0121
#define CONFIG_DEFAULT_DPLL_M_DIVIDER	0x5a//0x56 gallon 0121 set default DCLK=(27*90/8)/2/2=72.562MHz
#else
