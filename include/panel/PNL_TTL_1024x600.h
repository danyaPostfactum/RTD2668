...
#define CONFIG_DISPLAY_PANEL_STYLE			_PANEL_INTERFACE_TTL
...
#define CONFIG_DISPLAY_CLOCK_MAX 67
#define CONFIG_DISPLAY_REFRESH_RATE 60
#define CONFIG_DISPLAY_CLOCK_TYPICAL 51//25	// hsliao 20081008

/*
 * Display total window setup
 */
#define CONFIG_DISP_HORIZONTAL_TOTAL 	1344//800
#define CONFIG_DISP_VERTICAL_TOTAL 		635
...
#define CONFIG_DISP_DEN_END_HPOS 1024+32//640+32
#define CONFIG_DISP_DEN_STA_VPOS 16
#define CONFIG_DISP_DEN_END_VPOS 600+16
/*
 * Display active window setup
 */
#define CONFIG_DISP_ACT_STA_HPOS 0
#define CONFIG_DISP_ACT_END_HPOS 1024//640
#define CONFIG_DISP_ACT_STA_VPOS 0
#define CONFIG_DISP_ACT_END_VPOS 600
#define CONFIG_DISP_HSYNC_LASTLINE 525
#define CONFIG_DISP_DCLK_DELAY 0


#define _CONFIG_DISP_ACT_STA_BIOS 		0x00
#define CONFIG_DEFAULT_DPLL_M_DIVIDER	0x3E
