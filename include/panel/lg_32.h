...
#define CONFIG_DISPLAY_BITMAPPING_TABLE	_PANEL_DISPLAY_BITMAPPING_TABLE2 // 1 	// 0: Table1, 1:Table2
...
#define CONFIG_DISPLAY_HORIZONTAL_SYNC_NORMAL 0
#define CONFIG_DISPLAY_HORIZONTAL_SYNC 0 // 0: normal, 1: Invert
#define CONFIG_DISPLAY_VERTICAL_SYNC 0		// 0: normal, 1: Invert
#define CONFIG_DISPLAY_HORIZONTAL_SYNC 0 // 0: normal, 1: Invert
#define CONFIG_DISPLAY_RATIO_4X3 0		// 0: 16:9 , 1: 4:3
#define CONFIG_DISPLAY_CLOCK_MAX 80  //hpwang 
#define CONFIG_DISPLAY_REFRESH_RATE 75
#define CONFIG_DISPLAY_CLOCK_TYPICAL (70)
/*
 * Display total window setup
 */
#define CONFIG_DISP_HORIZONTAL_TOTAL 1526//1519
#define CONFIG_DISP_VERTICAL_TOTAL 784//790
 ...
 */
#define CONFIG_DISP_DEN_STA_HPOS 150//111
#define CONFIG_DISP_DEN_END_HPOS (1366+150)//1477
#define CONFIG_DISP_DEN_STA_VPOS 16//20
#define CONFIG_DISP_DEN_END_VPOS (16+768)//788
...
#define CONFIG_DISP_HSYNC_LASTLINE 1526//1519
#define CONFIG_DISP_DCLK_DELAY 2

#define _CONFIG_DISP_ACT_STA_BIOS 	0x00
#define CONFIG_DEFAULT_DPLL_M_DIVIDER	0x54 //hpwang 20071119 set default DCLK=(27*84/8)/2/2=70.8MHz
...
#define	LVDS_TO_PANEL_OFF_ms		150   // Delay(T5+T6): LVDS Signal Off --> Panel Power Off
////////////////////////////
//Panel Off--> Next On
////////////////////////////
#define	PANEL_OFF_TO_ON_ms		2000     // Delay(T7):    Totally Off --> Next On
