...
#define CONFIG_DISPLAY_CLOCK_MAX 140
#define CONFIG_DISPLAY_CLOCK_TYPICAL 132//MHz
...
#define CONFIG_DISP_HORIZONTAL_TOTAL 2016
#define CONFIG_DISP_VERTICAL_TOTAL 1116
